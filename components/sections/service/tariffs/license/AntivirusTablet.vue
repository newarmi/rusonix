...
<div>
    ...
    <select v-model="lineNumber" class="antispam__select antispam__select--tablet">
    ...
    <select v-model="optionsNumbers[lineNumber]" class="antispam__select antispam__select--tablet">
    ...
    <div class="antispam__month antispam__month--tablet">
      {{ period }}
    </div>
